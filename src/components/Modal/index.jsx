...
const ModalText = ({ text }) => (
  <div className="modal-text">
    ...
    <h5>
    In web and application design, a pop-up modal window
     is a user experience pattern that is often employed to interrupt a user’s activity, 
     drawing their attention to something more important. 
