...
const Notification = ({ notifications, setNotifications, notification }) => {
  ...
  const styleType = () => {
    ...
    switch (style) {
      case "success":
        return { background: "linear-gradient(15deg, #bcd0e8, #7274ee)" };
      case "error":
        return { background: "linear-gradient(15deg, #ec808d, #f4260b)" };
      case "warning":
        return { background: "linear-gradient(15deg, #eb95ce, #ae1fca)" };
      case "light":
        return { background: "linear-gradient(15deg, #e7e7e7, #be7d7d)" };
      default:
